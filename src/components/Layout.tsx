...
export default function Layout() {
    ...
    const getNavigation = () => {
        ...
        const adminNav = [ // Owner & Supervisor
            ...
            { name: 'Clientes Autorizados', href: '/admin/customers', icon: UsersIcon },
                            ...
                            <div className="flex items-center gap-x-4 lg:gap-x-6">
                                ...
                                <div className="flex items-center gap-x-4">
                                    <span className="hidden lg:flex lg:flex-col lg:items-end">
                                        <span className="text-sm font-semibold leading-6 text-brand-900">{user?.name || user?.email || 'Premium User'}</span>
